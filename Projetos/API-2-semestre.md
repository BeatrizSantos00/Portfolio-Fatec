...
Atuei como **Dev Team**, participando principalmente das frentes de modelagem de banco de dados e desenvolvimento de interface.

**🗂️ Modelagem do Banco de Dados**
- Participei da elaboração do Diagrama Entidade-Relacionamento (DER) do sistema, contribuindo para a definição das entidades, atributos e relacionamentos utilizados no fluxo de avaliações, grupos, critérios e sprints.
- O diagrama serviu como base para a implementação da camada de persistência em MySQL.

**🖥️ Desenvolvimento de Interface — JavaFX**
- Contribuí com o desenvolvimento da tela inicial do perfil de aluno em JavaFX/Scene Builder.
- Ajudei com ajustes de layout e pequenas melhorias visuais em outras telas do sistema ao longo do desenvolvimento.
